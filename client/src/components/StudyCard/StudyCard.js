    ...
    return (
        <div className={classItem}>
            <div onClick={handleSwitchSide} className="cards-slider__item">
                <div className={`cards-slider__item-title ${isActiveSide ? "cards-slider__item--active" : ""}`}>{card.title}</div>
                <div className={`cards-slider__item-dscr ${isActiveSide ? "" : "cards-slider__item--active"} `}>{card.definition}</div>
            </div>
            <div className="cards-actions">
                <div className="cards-actions--fav" onClick={handleAddToFavourite}><img src={isInFavourites ? favIcon : favSelectedIcon} /></div>
                {pageType === 'setPage' ?
                    <div className="cards-actions--repeat" onClick={handleAddToRepeat}><img src={isInRepeatList ? repeatIcon : repeatSelectedIcon} /></div> : null}
            </div>
